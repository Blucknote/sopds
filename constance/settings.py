...
BACKEND = getattr(
    settings, "CONSTANCE_BACKEND", "constance.backends.redisd.RedisBackend"
)
...
DATABASE_CACHE_AUTOFILL_TIMEOUT = getattr(
    settings, "CONSTANCE_DATABASE_CACHE_AUTOFILL_TIMEOUT", 60 * 60 * 24
)
...
IGNORE_ADMIN_VERSION_CHECK = getattr(
    settings, "CONSTANCE_IGNORE_ADMIN_VERSION_CHECK", False
)
