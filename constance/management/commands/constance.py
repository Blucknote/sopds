...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser_list = self._subparsers_add_parser(
            ...
            "list",
            cmd=self,
            help="list all Constance keys and their values",
        )

        parser_get = self._subparsers_add_parser(
            subparsers, "get", cmd=self, help="get the value of a Constance key"
        )
        parser_get.add_argument("key", help="name of the key to get", metavar="KEY")

        parser_set = self._subparsers_add_parser(
            subparsers, "set", cmd=self, help="set the value of a Constance key"
        )
        ...
        parser_set.add_argument(
            "value", help="value to set", metavar="VALUE", nargs="+"
        )
